...
const Signup = () => {
    ...
    return (
        ...
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"  style={{ backgroundImage: "url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80)" }}>
            ...
            <div className="bottom-24 absolute p-4 text-center right-0 left-0 flex justify-center space-x-4">
                <span>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#161616]" >
            ...
            <div className="w-full py-6 z-20">
                ...
                <div className="py-6 space-x-2">
                    ...
                    <span onClick={googleSignIn} className="w-10 hover:bg-slate-400 hover:cursor-pointer h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">G+</span>
                ...
                <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div className=" text-gray-400 hover:underline flex justify-between mt-3 hover:text-gray-100">
                        <a className='text-red-600 text-sm' href="#">Forgot your password?</a>
                        <Link to='/logout' className='text-sm' href="#">Create an Account</Link>
                    </div>
